...
<div class="row g-3 mb-4 project-collage">
  <div class="col-md-6 project-collage-item">
    <img src="{{ site.github.url }}/assets/img/wearable/wearable.png" alt="Wearable proposal concept" class="project-collage-image">
  </div>
  <div class="col-md-6 project-collage-item">
    <img src="{{ site.github.url }}/assets/img/wearable/matlab.png" alt="Wearable design analysis" class="project-collage-image">
  </div>
</div>

<div class="mb-4">
  <h4 class="fw-bold mb-3" style="font-size: 24px;">Reverse Engineering Final Paper</h4>
  <object data="{{ site.github.url }}/assets/Reverse%20Engineering%20Final%20Paper.pdf" type="application/pdf" width="100%" height="1000px" style="background: #f8f8f8;">
